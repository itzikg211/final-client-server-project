...
public class Properties implements Serializable {
	 ...
	 * 
	 */
	public Properties(MazeSolver mazeSolver,int threadNumber,MazeGenerator mazeGenerator, Boolean diagonal,double regCost,double diagonalCost,int portNumber,int numOfClients)
	{
